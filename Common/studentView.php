...
<title>Courtroom Simulator | Student View</title>
    ...
    <div class="container wrapper">
		<div class="row">
			...
			<div class="col-lg-5 studentTranscript mb-5">
                    <div class="row">
                        <img class="mx-auto d-block characterImg" src="<?php echo $home ?>images/Characters/Expert_Witness_02.png">    
                    </div>
                    <div class="row">
                        <div class="col-12">
           ...
           <div class="col-lg-5 studentTranscript mb-5">
                    <div class="row">
                        <img class="mx-auto d-block characterImg" style='width:9rem' src="<?php echo $home ?>images/Characters/Eye_Witness_02.png">    
                    </div>
                    <div class="row">
                        <div class="col-12">
